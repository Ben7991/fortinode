...
export default function Button({
  ...
  if (remainingProps.el === 'link') {
    return (
      <Link
        className={`${className} ${variantClassName} py-2 rounded-md`}
        {...remainingProps}
      >
  ...
  return (
    <button
      className={`${className} ${variantClassName} py-2 rounded-md disabled:cursor-not-allowed disabled:opacity-70`}
      {...remainingProps}
    >
      {remainingProps.children}
    </button>
